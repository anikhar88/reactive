package com.anxistars.flux.webfluxdemo.config;
import com.anxistars.flux.webfluxdemo.service.CalculatorHandler;
...
@Configuration
@ComponentScan("com.anxistars.flux.webfluxdemo.config")
